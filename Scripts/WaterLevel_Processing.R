...
path.WL<-here("Data","June2022","Varari_Sled","20220607","raw_files")
file.date <- "20220607" # logger date 

### Output
# Path to store logger files
file.output<-here("Data","June2022","Varari_Sled","20220607","QC_files") # Output file path; Spatial vs Timeseries survey
