...
path.log<-here("Data","June2022","Varari_Sled", "20220613","raw_files") # Logger in situ file path (CT and Water Level files)
file.date <- "20220613" # logger date used in file name(s)

### Output
# Path to store logger files
path.output<-here("Data","June2022","Varari_Sled", "20220613","QC_files") # Output file path
...
# Log dates
start.date <- ymd('2022-06-13')
end.date <- ymd('2022-06-19')
