...
foldername<-'011021' # folder of the day
Serial<-735719 # Logger's serial number ID
filename_cat<-'20200310_Cat.csv' # concatenated data from miniDOT Logger
Launch<-'2021-01-10 14:55:00' # Maintain date time format "2020-03-04 14:15:00"
Retrieval<-'2021-01-10 17:02:00' # Maintain date time format "2020-03-04 21:30:00"
Date <- 011021 # today's date
