...
path.log<-here("Data","August2021","Tetiaroa","20210812","raw_files") # Logger in situ file path (CT and Water Level files)
file.date <- "20210814" # logger date used in file name(s)

### Output
# Path to store logger files
path.output<-here("Data","August2021","Tetiaroa","20210812","QC_files") # Output file path
...
# Log dates
start.date <- ymd('2021-08-13')
end.date <- ymd('2021-08-14')
